...
function make_base() {
        ...
        document.getElementById("personName1").innerHTML = " عائلة ديفوتيم تهنئك بعيد الاضحى المبارك"; // mah - what should i put here? from devoteam 
        ...
        // document.getElementById('input2').style.marginBottom = '270px'
}
